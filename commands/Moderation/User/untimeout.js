...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if(interaction.member.id === timeMember.id) return await interaction.reply({ content: `${abc.icons.crossmark} You cannot untimeout yourself!`, ephemeral: true });
        ...
        .setDescription(`${abc.icons.checkmark} <@${timeMember.id}> was untimeout with the reason of: ${reason}.`)
